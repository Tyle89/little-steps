// Reference data for the development checklist, grouped by age bracket.
// minDays/maxDays (age in days since birth) let ChecklistView.vue
// auto-detect which bracket the child currently falls into.
//
// The milestone text itself stays in French - this is user-facing content
// shown directly in the UI, not code, so it is not translated here.
// Sourced from general, widely-published child development milestones
// (not a proprietary or copyrighted checklist).
